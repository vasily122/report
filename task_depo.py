...
os.system("""(sync;uptime;date;ps ax) | mail -s "deposerv alive test 1" vasily122@yandex.ru""")

#os.system("""(sync;uptime;date;ps ax) | mail -s "deposerv task" vasily122@yandex.ru""")system("""(date;uptime;lshw;inxi -AbD 2>&1) | mail -s "s5000 task" vasily122@yandex.ru""")
