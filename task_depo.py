...
# -*- coding: utf-8 -*- 
#import os
#os.system("""(sync; date ; uptime; ps ax )| mail -s "boinc DepoServ" vasily122@yandex.ru""")
...
#os.system("""(date;python3 --version;uptime)|mail -s "depo python versions" vasily122@yandex.ru""")
